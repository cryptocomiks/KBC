...
VARIANT_FAMILIES: list[list[str]] = [
    ["muhammad", "mohamed", "mohammed", "mohammad", "mohamad", "muhammed", "muhamed",
     "mohammd", "mouhamed", "mouhammad", "mahomed", "maxamed", "mehmet", "mehmed"],
...
_PERSON_NOISE = {"mr", "mrs", "ms", "dr", "sir", "madame", "monsieur", "mme", "m", "sheikh",
                 "al", "el", "bin", "ben", "ibn", "von", "van", "de", "der", "da", "di"}

# Legal forms, removed when comparing company names.
_LEGAL_FORMS = {
    "sa", "sas", "sasu", "sarl", "eurl", "sci", "snc", "sca", "scs", "gie", "selarl",
    "s a r l", "sarl", "ltd", "limited", "llc", "llp", "lp", "plc", "inc", "incorporated",
    "corp", "corporation", "co", "company", "gmbh", "ag", "kg", "bv", "nv", "spa", "srl",
    "sl", "oy", "ab", "as", "aps", "sàrl", "sàrl", "se", "fze", "fzco", "fzc", "pte", "pty",
}
_LEGAL_FORM_PATTERNS = [r"\bs a r l\b", r"\bs a s\b", r"\bs a\b", r"\bs e n c\b"]

_PHONETIC_RULES: list[tuple[str, str]] = [
    (r"sch", "sh"), (r"tch", "ch"), (r"tsch", "ch"), (r"dj", "j"), (r"dzh", "j"),
    (r"zh", "j"), (r"kh", "h"), (r"gh", "g"), (r"ph", "f"), (r"th", "t"), (r"ck", "k"),
    (r"q", "k"), (r"c(?=[aou])", "k"), (r"w", "v"), (r"ou", "u"), (r"oo", "u"),
    (r"ee", "i"), (r"ie", "i"), (r"y", "i"), (r"ey$", "i"), (r"(.)\1+", r"\1"),
]
